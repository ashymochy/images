...
import PlaceholderImage from './pictures/photo2.jpg'; 
import AnotherImage from './pictures/photo1.jpg';
  ...
  return (
    <div className="App">
      <React.Fragment>
        ...
        <TextField id="textfield1" classname="custom-textfield" text="Classname" background="white" />
